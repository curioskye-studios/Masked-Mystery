...
func _on_red_mask_pressed() -> void:
	get_tree().change_scene_to_file("res://Investigation Screen/Scenes/red_scene_1.tscn")
	
func _on_yelllow_mask_pressed() -> void:
	get_tree().change_scene_to_file("res://Investigation Screen/Scenes/yellow_scene_1.tscn")
