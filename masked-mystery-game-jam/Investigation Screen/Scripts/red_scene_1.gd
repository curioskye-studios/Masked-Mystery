...
func _on_yelllow_mask_pressed() -> void:
	get_tree().change_scene_to_file("res://Investigation Screen/Scripts/yellow_scene_1.gd")

func _on_blue_mask_pressed() -> void:
	get_tree().change_scene_to_file("res://Investigation Screen/Scripts/blue_scene_1.gd")
